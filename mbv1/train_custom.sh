...
python3 main_regression.py --custom_model --regression --dataset ${dataset} --save "split/saved_models/${expname}/finetune/" --no-cuda --epochs 300 --input-dim 1 --hidden-dim 10 --output-dim 1 
